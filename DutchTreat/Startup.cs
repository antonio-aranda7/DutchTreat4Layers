...
namespace DutchTreat
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      // a lot of applications separate out identity context and app data co.text.
      ...
      }).AddEntityFrameworkStores<DutchContext>();// AddEntityFrameworkStores
      ...
      services.AddDbContext<Data.DutchContext>(cfg => cfg.UseSqlServer(_config.GetConnectionString("DutchConnectionString")));
      ...
      services.AddTransient<DutchBL>();

      // add IDutchRepository with implementation DutchRepository
      services.AddScoped<DutchBL, DutchRepository>();
